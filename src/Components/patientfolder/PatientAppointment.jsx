...
export default function SinglePhysicianDisplay() {
	...
	const getSingleAppointment = async () => {
		...
		try {
			const appointment = await axios.get(`http://localhost:5000/appointment/${id}`, {
				headers: {
					...
					<div className="modal-content">
						...
						<div className="modal-body">
							<p>
								...
								temporibus esse expedita illum explicabo voluptates consectetur odit
								maxime voluptatibus sequi vel porro! Consequatur ut totam dolores.
								Dolor beatae mollitia modi.
							</p>
						</div>
					</div>
				</div>
