...
export default function DoctorProfile() {
	...
	const [awardsNAchievements, setAwardsNAchievements] = useState([{ awards: "", year: "" }]);
	const [licence, setLicence] = useState([{ licenseNumber: "", yearOfIssued: "" }]);
	...
	const getDocInfo = async () => {
		...
		if (docInfo) {
			...
			setPic(docInfo?.profilePicture || "/assets/img/banners/defualtImgjpg.jpg");
	...
	const handleFormSubmit = async (e) => {
		...
		try {
			...
			if (docInfo) {
				...
				localStorage.setItem("docInfo", JSON.stringify(updatedDoctor.data.result));
				...
				console.log(user);
				localStorage.setItem("docInfo", JSON.stringify(user.data.result.doctor));
	...
	const handleCountryChange = (val) => {
		...
		const selectedCountry = Country.getAllCountries().find((c) => c.name === val);
						...
						<div className="col-md-7 col-lg-8 col-xl-9">
												...
												<div className="change-avatar">
													...
													<div className="upload-img">
														...
														<small className="form-text text-muted">
															Allowed JPG, PNG and JPEG. Max size of
															2MB
														</small>
													</div>
												</div>
							...
							<div className="card">
								<div className="card-body">
									...
									<div className="mb-0">
										<label className="mb-2">
											Biography (Your biography will be displayed to the
											patient when scheduling an appointment.)
										</label>
										<textarea
											className="form-control"
							...
							<div className="button-group mb-3">
								<button
									...
									className={`btn  ${!showClinic ? "text-white prime-btn" : ""}`}
								>
									Address
								</button>
								<button
