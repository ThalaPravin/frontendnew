...
export default function DoctorProfile() {
	...
	const getDocInfo = async () => {
		...
		if (docInfo) {
			...
			setPic(docInfo?.profilePicture || "assets/img/doctors/doctor-thumb-02.jpg");
	...
	const getPdf = async () => {
		const pdf = "http://localhost:5000/files/1715146045722-149767159Project Management (1).pdf";
													...
													<div className="change-avatar">
														...
														<div className="upload-img">
															...
															<small className="form-text text-muted">
																Allowed JPG, PNG and JPEG. Max size
																of 2MB
															</small>
														</div>
													</div>
                        ...
                        {fileName.toLowerCase().endsWith(".pdf") ? (
                          ...
                          />
										...
										<iframe
											...
											src={`http://localhost:5000/files/${uploadedFileName}`}
										></iframe>
									</div>
								</div>
