...
export default function Patientprofile() {
  ...
  const handlePrecriptionSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        "https://healthcare-backend-o4vb.onrender.com/appointment/prescription",
        {
  ...
  const handleSaveObservation = async () => {
    ...
    try {
      const observationres = await axios.put(
        `https://healthcare-backend-o4vb.onrender.com/appointment/observation/`,
        {
      ...
      const appointment = await axios.get(
        `https://healthcare-backend-o4vb.onrender.com/appointment/${appointmentId}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: isAuthenticated,
  ...
  const handleEncounters = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://healthcare-backend-o4vb.onrender.com/appointment/previous-encouters?date=${backendDate}&patientId=${singleAppointment?.patient?._id}`,
        {
          headers: {
            "Content-Type": "application/json",
            authorization: isAuthenticated,
  ...
  const handleReportSubmit = async (e) => {
    ...
    try {
      ...
      const uploadResult = await axios.post(
        "https://healthcare-backend-o4vb.onrender.com/service/uploadPdf",
        formData,
        {
          headers: {
      ...
      const [reportUploadResult, appReportUploadResult] = await Promise.all([
        axios.put(
          `https://healthcare-backend-o4vb.onrender.com/doctor/${patientId}/report`,
          reportData,
          {
            headers: {
              isvalidrequest: "twinsistech",
        ...
        axios.put(
          `https://healthcare-backend-o4vb.onrender.com/doctor/${appointmentId}/AppointmentReport`,
          reportData,
          {
            headers: {
              isvalidrequest: "twinsistech",
  ...
  // 				`https://healthcare-backend-o4vb.onrender.com/doctor/${appointmentId}/report`,
  // 				reportData,
  // 				{
  // 					headers: {
  // 						isvalidrequest: "twinsistech",
                  ...
                  <div className="card-body">
                    <div className="pro-widget-content">
                      <div className="profile-info-widget">
                        <a href="#" className="booking-doc-img">
                          <img
                            src={
                              singleAppointment?.patient?.profilePicture ||
                        ...
                        <div className="profile-det-info">
                          <h3>{singleAppointment?.patient?.userId?.name}</h3>
                          <div className="patient-details">
                            <h5>
                              <b>Patient ID :</b>
                              {singleAppointment?.patient?.userId?._id}
                            </h5>
                            <h5 className="mb-0">
                    ...
                    <div className="patient-info">
                      <ul>
                        ...
                        <li>
                          Age <span>{singleAppointment?.patient?.age}</span>
                        </li>
                        <li>
                          Blood Group{" "}
                          <span>{singleAppointment?.patient?.bloodType}</span>
                        </li>
                        <li>
                          DOB{" "}
                          <span>
                            ...
                            ).toDateString(singleAppointment?.patient?.dob)}
                          </span>
                        </li>
                        <li>
                          Gender
                          <span>{singleAppointment?.patient?.gender}</span>
                        </li>
                        <li>
                          Email
                          <span>
                            {singleAppointment?.patient?.userId?.email}
                          </span>
                        </li>
                        <li>
                          Height
                          <span>{singleAppointment?.patient?.height} Feet</span>
                        </li>
                        <li>
                          Weight
                          <span>{singleAppointment?.patient?.weight} KG</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="col-12 col-md-6 col-lg-4 col-xl-3 patient-dashboard-top">
                    <div className="card">
                      <div className="card-body text-center">
                        ...
                        <h5>Heart Rate</h5>
                        <h6>
                          {singleAppointment?.vitals?.heartRate} <sub>bpm</sub>
                        </h6>
                      </div>
                    </div>
                  </div>
                  <div className="col-12 col-md-6 col-lg-4 col-xl-3 patient-dashboard-top">
                    <div className="card">
                      <div className="card-body text-center">
                        ...
                        <h6>
                          {singleAppointment?.vitals?.temparature} <sub>C</sub>
                        </h6>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="card card-table mb-0">
                          <div className="card-body">
                            <div className="table-responsive">
                              ...
                              >
                                {displayReport ? "Remove Report" : "Add Report"}
                              </button>
                              {displayReport && (
                                <form
                                ...
                                <tbody>
                                  ...
                                  {encounters?.map((encounter, index) => (
                                    <tr key={index}>
                                      ...
                                      <td>
                                        {new Date(encounter?.date).toDateString(
                                          encounter?.date
                                        )}
                                      </td>
                                      <td>
            ...
            <div className="modal-body">
              <div className="card border-0">
                <div className="card-body">
                  ...
                  {singleAppointment?.patient?.allergies.map(
                    (allergy, index) => (
                      <ul key={index} className="list-unstyled">
                        <li>{allergy}</li>
